...
<div class="container">
    ...
    <aside>
        ...
        <div class="sidebar">
            ...
            <a href="/DevSync/MyTask?action=listAll" class="active">
                    <span class="material-icons-sharp">
                        inventory
                    </span>
                <h3>My Tasks</h3>
    ...
    <main>
        ...
        <div class="recent-orders">
            <h2>All Tasks</h2>
            <a href="MyTask?action=add">Add new Task</a>
            <table>
                <thead>
                <tr>
                    <th>Title</th>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/DevSync/MyTask?action=edit&id=<%= task.getId() %>"
                           onclick="return confirm('Are you sure you want to edit this Task?');" style="color: orange">Edit</a>
                    </td>
                    <td><a href="/DevSync/MyTask?action=delete&id=<%= task.getId() %>"
                           onclick="return confirm('Are you sure you want to delete this task?');" style="color: red">Delete</a></td>
